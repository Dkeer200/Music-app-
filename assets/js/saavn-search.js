                ...
                <div class="text-left song-container" style="margin-bottom:20px;border-radius:10px;background-color:#1c1c1c;padding:10px;">
                    <div class="row" style="margin:auto;">
                        ...
                        <div class="col" style="border-style:none;padding:2px;">
                            ...
                            <button class="btn btn-primary song-btn" type="button" style="margin:0px 2px;" onclick='DownloadSong("${download_url}")'>Download</button>
...
// Function to manually seek the audio using the slider
function SeekAudio(event) {
    var progressBar = document.querySelector("#progress-bar");
    var seekTime = (event.target.value / 100) * audioPlayer.duration;
    audioPlayer.currentTime = seekTime;
...
// Add an event listener to the progress bar for manual seeking
document.querySelector("#progress-bar").addEventListener("input", SeekAudio);

// Example HTML for slider and time display
/*
<div id="controller-bar">
    <img id="player-image" src="" alt="Song Art" style="width:50px;height:50px;">
    <div>
